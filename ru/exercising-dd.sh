...
# Script by Stephane Chazelas.  # Somewhat modified by ABS Guide author.
...
echo -n "hello vertical world" | dd cbs=1 conv=unblock 2> /dev/null # Echoes
"hello vertical world" vertically downward.  # Why? A newline follows each
character dd emits.
