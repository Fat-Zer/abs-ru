#!/bin/bash # test-cgi.sh # by Michael Zick # Used with permission
...
# Header tells browser what to expect.  echo Content-type: text/plain echo

echo CGI/1.0 test script report: echo

echo environment settings: set echo

echo whereis bash? whereis bash echo


echo who are we? echo ${BASH_VERSINFO[*]} echo

echo argc is $#. argv is "$*".  echo
...
# Here document to give short instructions.  :&lt;&lt;-'_test_CGI_'
