#!/bin/bash # obj-oriented.sh: Object-oriented programming in a shell
script.  # Script by Stephane Chazelas.

# Important Note: # --------- ---- # If running this script under version 3
or later of Bash, #+ replace all periods in function names with a "legal"
...
person.new self Bozeman Bozo 101272413 # Create an instance of "person.new"
(actually passing args to the function).
...
# typeset -f #+ to see the created functions (careful, it scrolls off the
page).
